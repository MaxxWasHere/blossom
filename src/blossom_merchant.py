...
# Coteab Merchant_Handler base timings × 0.25 (75% faster click pacing).
_COTEAB_MERCHANT_TIMING = 0.25
...
MERCHANT_SLOT_SETTLE_SEC = 0.15 * _COTEAB_MERCHANT_TIMING
...
def _click_delay_sec(config: dict) -> float:
    return inventory_click_delay_sec(config, default_ms=350) * _COTEAB_MERCHANT_TIMING
